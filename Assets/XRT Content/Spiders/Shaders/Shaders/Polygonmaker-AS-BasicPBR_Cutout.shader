...
Shader "Polygonmaker/Basic-PBR (Cutout Double Side)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( ( ( _ColorR * tex2DNode22.r ) + ( 1.0 - tex2DNode22.r ) ) * ( ( _ColorG * tex2DNode22.g ) + ( 1.0 - tex2DNode22.g ) ) * ( ( _ColorB * tex2DNode22.b ) + ( 1.0 - tex2DNode22.b ) ) * ( ( _SkinHairColor * fresnelNode20 * tex2D( _SkinMaskB, uv_SkinMaskB ).b ) + ( _Color * tex2DNode1 ) ) ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), 1.0f );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = tex2DNode4.r;
				...
				surfaceDescription.Smoothness = ( tex2DNode4.a * _GlossMapScale );
...
ASEEND*/
//CHKSM=3B21FFC0382CDCE68E48DF7EF17706D4F8B52E04