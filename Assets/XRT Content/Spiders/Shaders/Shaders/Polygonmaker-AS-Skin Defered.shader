...
Shader "Polygonmaker/Skin - Deferred"
{
	Properties
	{
		...
		_EmissionColorHDR("Emission Color", Color) = (0,0,0,0)
		_EmissionIntensity("Emission Intensity", Range( 0 , 10)) = 1
		_HDRPboost1("HDRP boost", Float) = 1000
		_SkinHairColor("Skin Hair - Color", Color) = (0,0,0,0)
		_SkinHairIntensity("Skin Hair Intensity", Range( 0 , 5)) = 1
		_SkinMaskB("Skin Mask (B)", 2D) = "white" {}
		
		[DiffusionProfile]_SSSProfile2("SSS Profile", Float) = 0[HideInInspector]_SSSProfile2_Asset("SSS Profile", Vector) = ( 0, 0, 0, 0 )
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float fresnelNode20 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV20, _SkinHairIntensity ) );
				float2 uv_SkinMaskB = packedInput.ase_texcoord5.xy * _SkinMaskB_ST.xy + _SkinMaskB_ST.zw;
				float4 tex2DNode47 = tex2D( _SkinMaskB, uv_SkinMaskB );
				...
				surfaceDescription.BaseColor = ( ( ( _ColorR * tex2DNode22.r ) + ( 1.0 - tex2DNode22.r ) ) * ( ( _ColorG * tex2DNode22.g ) + ( 1.0 - tex2DNode22.g ) ) * ( ( _ColorB * tex2DNode22.b ) + ( 1.0 - tex2DNode22.b ) ) * ( ( _SkinHairColor * fresnelNode20 * tex2DNode47.b ) + ( _Color * tex2D( _MainTex, uv_MainTex ) ) ) ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), 1.0f );
				...
				surfaceDescription.Emission = ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissionColorHDR * _EmissionIntensity * _HDRPboost1 ).rgb;
				surfaceDescription.Smoothness = ( tex2D( _MetallicGlossMap, uv_MetallicGlossMap ).a * _GlossMapScale );
				surfaceDescription.Occlusion = tex2D( _OcclusionMap, uv_OcclusionMap ).g;
				...
				#ifdef _MATERIAL_FEATURE_TRANSMISSION
				surfaceDescription.TransmissionMask = ( _SSSProfile2 * tex2DNode47.b );
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float fresnelNode20 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV20, _SkinHairIntensity ) );
				float2 uv_SkinMaskB = packedInput.ase_texcoord2.xy * _SkinMaskB_ST.xy + _SkinMaskB_ST.zw;
				float4 tex2DNode47 = tex2D( _SkinMaskB, uv_SkinMaskB );
				...
				float2 uv_MetallicGlossMap = packedInput.ase_texcoord2.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				
				float2 uv_OcclusionMap = packedInput.ase_texcoord2.xy * _OcclusionMap_ST.xy + _OcclusionMap_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float fresnelNdotV20 = dot( normalWS, V );
				float fresnelNode20 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV20, _SkinHairIntensity ) );
				float2 uv_SkinMaskB = packedInput.ase_texcoord7.xy * _SkinMaskB_ST.xy + _SkinMaskB_ST.zw;
				float4 tex2DNode47 = tex2D( _SkinMaskB, uv_SkinMaskB );
...
/*ASEBEGIN
Version=19202
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3;-427.3237,16.42108;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;2;-875.3236,-111.5789;Float;False;Property;_Color;Main Color;1;0;Create;False;0;0;0;False;0;False;1,1,1,0;0.7546332,1,0.5377356,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-923.3236,64.42109;Inherit;True;Property;_MainTex;Diffuse;0;0;Create;False;0;0;0;False;0;False;-1;None;24b68c8b8149f3744b9c26a1069dac89;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;4;-845.101,421.7313;Inherit;True;Property;_MetallicGlossMap;Metallic (R), Gloss (Alpha);2;0;Create;False;0;0;0;False;0;False;-1;d340fcb74c944e046b0860161abc4821;2b3127d2659588140b7c072e4a17e58d;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;5;-816.8608,236.1953;Inherit;True;Property;_BumpMap;Normal;6;0;Create;False;0;0;0;False;0;False;-1;None;2a543b0290d3dca46a8959a1752a623c;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;6;-474.2967,566.2061;Float;False;Property;_GlossMapScale;Glossiness Intensity;3;0;Create;False;0;0;0;False;0;False;1;1.58;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;7;-119.0916,486.9873;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;8;96.53375,-13.315;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;12;Polygonmaker/Skin - Deferred;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;34;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;True;0;True;_StencilRefGBuffer;255;False;;255;True;_StencilWriteMaskGBuffer;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;False;True;0;True;_ZTestGBuffer;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;39;Surface Type;0;0;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;1;0;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;5;638298780108028263;  Energy Conserving Specular;1;0;  Transmission,InvertActionOnDeselection;0;0;Forward Only;0;0;Receive Decals;1;0;Receives SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;DOTS Instancing;0;0;GPU Instancing;1;0;LOD CrossFade;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position;1;0;0;11;True;True;True;True;True;True;False;False;False;True;True;False;;False;0
Node;AmplifyShaderEditor.FresnelNode;20;-2115.947,-230.7454;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;22;-2319.787,-960.2892;Inherit;True;Property;_TextureSample0;Color Mask (R,G,B);8;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;23;-1910.36,-1139.599;Float;False;Property;_ColorR;Color (R);4;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;24;-1864.808,-724.8041;Float;False;Property;_ColorB;Color (B);7;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;25;-1873.408,-888.2042;Float;False;Property;_ColorG;Color (G);5;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;26;-1373.668,-807.0527;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;-1750.72,-263.4211;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;28;-1382.585,-677.1335;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-1537.672,-755.0345;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-1549.758,-999.614;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;31;-1379.252,-938.5422;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-1545.937,-862.3362;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;33;-994.9468,-1002.042;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;34;-2168.501,1023.934;Inherit;False;Property;_HDRPboost1;HDRP boost;13;0;Create;True;0;0;0;False;0;False;1000;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;36;-2010.725,687.0968;Inherit;True;Property;_EmissionMap;Emission;10;0;Create;False;0;0;0;False;0;False;-1;None;de9f5aa131f733a4c972f7748ec52c97;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;37;-998.7515,-860.1422;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;38;-1948.006,908.9645;Float;False;Property;_EmissionColorHDR;Emission Color;11;0;Create;False;0;0;0;False;0;False;0,0,0,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;39;-990.2684,-700.9539;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;40;-1910.305,1081.865;Float;False;Property;_EmissionIntensity;Emission Intensity;12;0;Create;True;0;0;0;False;0;False;1;8.13;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.DiffusionProfileNode;41;-1582.867,1207.62;Float;False;Property;_SSSProfile2;SSS Profile;17;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;-1630.806,739.9648;Inherit;False;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;43;-1995.107,1170.237;Inherit;True;Property;_OcclusionMap;Occlusion (G);9;0;Create;False;0;0;0;False;0;False;-1;None;2b3127d2659588140b7c072e4a17e58d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;44;-776.9127,-839.3652;Inherit;False;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;-1262.787,1290.618;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;47;-1818.955,1473.407;Inherit;True;Property;_SkinMaskB;Skin Mask (B);16;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;35;-213.3197,-155.4588;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-2486.53,-189.4712;Float;False;Property;_SkinHairIntensity;Skin Hair Intensity;15;0;Create;True;0;0;0;False;0;False;1;4;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;21;-2097.026,-403.326;Float;False;Property;_SkinHairColor;Skin Hair - Color;14;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;8;6;42;0
WireConnection;8;7;7;0
WireConnection;8;8;43;2
WireConnection;8;61;45;0
WireConnection;20;3;19;0
WireConnection;26;0;22;2
WireConnection;27;0;21;0
WireConnection;27;1;20;0
WireConnection;27;2;47;3
WireConnection;28;0;22;3
...
WireConnection;42;3;34;0
WireConnection;44;0;33;0
WireConnection;44;1;37;0
WireConnection;44;2;39;0
WireConnection;44;3;35;0
WireConnection;45;0;41;0
WireConnection;45;1;47;3
WireConnection;35;0;27;0
WireConnection;35;1;3;0
ASEEND*/
//CHKSM=2F6093EA32B755722F123DDDC2028CC494CAD7F6