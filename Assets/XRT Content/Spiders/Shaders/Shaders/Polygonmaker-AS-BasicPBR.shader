	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( ( ( _ColorR * tex2DNode22.r ) + ( 1.0 - tex2DNode22.r ) ) * ( ( _ColorG * tex2DNode22.g ) + ( 1.0 - tex2DNode22.g ) ) * ( ( _ColorB * tex2DNode22.b ) + ( 1.0 - tex2DNode22.b ) ) * ( ( _SkinHairColor * fresnelNode20 * tex2D( _SkinMaskB, uv_SkinMaskB ).b ) + ( _Color * tex2D( _MainTex, uv_MainTex ) ) ) ).rgb;
...
ASEEND*/
//CHKSM=0ABFDD75DD9FB916C174A6606088481F6D0856EC