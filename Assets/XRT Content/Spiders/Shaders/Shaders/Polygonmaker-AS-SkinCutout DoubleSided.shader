	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( ( ( _ColorR * tex2DNode22.r ) + ( 1.0 - tex2DNode22.r ) ) * ( ( _ColorG * tex2DNode22.g ) + ( 1.0 - tex2DNode22.g ) ) * ( ( _ColorB * tex2DNode22.b ) + ( 1.0 - tex2DNode22.b ) ) * ( ( _SkinHairColor * fresnelNode20 * tex2DNode47.b ) + ( _Color * tex2DNode1 ) ) ).rgb;
...
Node;AmplifyShaderEditor.SamplerNode;1;-996.1761,71.1667;Inherit;True;Property;_MainTex;Diffuse;0;0;Create;False;0;0;0;False;0;False;-1;None;24b68c8b8149f3744b9c26a1069dac89;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=4ACD7E70AA0110D6CE5B0CCD725E3490355A0235